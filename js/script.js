...
var corpo = document.querySelector("header");///// preciso????????????
...
var defaultTeam = function () {
  ...
  var form = document.createElement("form"); //******** mudei de button para form */
...
if (teamUm !== undefined & teamDois !== undefined) {
    ...
    criarDiv.appendChild(form); //botao
